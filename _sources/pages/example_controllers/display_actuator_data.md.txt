...
This example streams data from an actuator to the terminal, showing position, velocity, and torque/current (depending on the device version). In this example, you can see how to read data from the actuators.
...
```
::::{button-link} https://github.com/gatech-epic-power/epically-powerful/blob/main/examples/display_actuator_data.py
    :expand:
    :color: primary
    :shadow:
